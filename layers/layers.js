...
var format_SIGNALISATIONTOURISTIQUEGMVA_1 = new ol.format.GeoJSON();
var features_SIGNALISATIONTOURISTIQUEGMVA_1 = format_SIGNALISATIONTOURISTIQUEGMVA_1.readFeatures(json_SIGNALISATIONTOURISTIQUEGMVA_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SIGNALISATIONTOURISTIQUEGMVA_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SIGNALISATIONTOURISTIQUEGMVA_1.addFeatures(features_SIGNALISATIONTOURISTIQUEGMVA_1);
var lyr_SIGNALISATIONTOURISTIQUEGMVA_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_SIGNALISATIONTOURISTIQUEGMVA_1, 
                style: style_SIGNALISATIONTOURISTIQUEGMVA_1,
                interactive: true,
                title: '<img src="styles/legend/SIGNALISATIONTOURISTIQUEGMVA_1.png" /> SIGNALISATION TOURISTIQUE GMVA'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_SIGNALISATIONTOURISTIQUEGMVA_1.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_SIGNALISATIONTOURISTIQUEGMVA_1];
lyr_SIGNALISATIONTOURISTIQUEGMVA_1.set('fieldAliases', {'Satut_Pann': 'Satut_Pann', 'N_Photo': 'N_Photo', 'Commune': 'Commune', 'Type_Voie': 'Type_Voie', 'Voie': 'Voie', 'Carrefour': 'Carrefour', 'Lame': 'Lame', 'N_Mention': 'N_Mention', 'Thématiqu': 'Thématiqu', 'Site_signa': 'Site_signa', 'SCHEMA_DIR': 'SCHEMA_DIR', 'Site_valid': 'Site_valid', 'Phasage_pr': 'Phasage_pr', 'Site_val_1': 'Site_val_1', 'Niveau_de_': 'Niveau_de_', 'CAS_DE_FIG': 'CAS_DE_FIG', 'Commune_du': 'Commune_du', 'Catégorie': 'Catégorie', 'Mention': 'Mention', 'Idéogramm': 'Idéogramm', 'Idéogra_1': 'Idéogra_1', 'Sens_Flèc': 'Sens_Flèc', 'Type_panne': 'Type_panne', 'Type_mat': 'Type_mat', 'Etat': 'Etat', 'Conformit�': 'Conformit�', 'Remarque': 'Remarque', 'Bilinguism': 'Bilinguism', 'Coût_pann': 'Coût_pann', 'Coût_pose': 'Coût_pose', 'Coût_mât': 'Coût_mât', 'Coût_po_1': 'Coût_po_1', 'Coût_dép': 'Coût_dép', 'Coût_d�_1': 'Coût_d�_1', 'TOTAL': 'TOTAL', 'Coût_Four': 'Coût_Four', 'Coût_Po_2': 'Coût_Po_2', 'Coût_D�_2': 'Coût_D�_2', 'Id_mat_2': 'Id_mat_2', });
...
lyr_SIGNALISATIONTOURISTIQUEGMVA_1.on('precompose', function(evt) {
